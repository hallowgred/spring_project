            ...
            <ul id="asd">
                ...
                <li>
                    <select class="add_select1" id="spart1">
                        ...
                        <option value="ex">임원</option>
                        <option value="com">전산팀</option>
                        <option value="des">디자인팀</option>
                        <option value="cs">CS팀</option>
                        <option value="md">MD팀</option>
                    </select>
                    <select class="add_select1" id="spart2">
                        <option value="">담당자 직책을 선택하세요</option>
                        <option value="re">대표</option>
                        <option value="dr">부장</option>
                        <option value="tl">팀장</option>
                        <option value="eg">과장</option>
                        <option value="dep">대리</option>
                        <option value="em">사원</option>
                    </select>
                </li>
