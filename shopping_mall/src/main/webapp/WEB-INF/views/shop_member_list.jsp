...
<section>
    ...
    <ol class="new_admin_lists">
        ...
        <li>
        	...
        	<input type="hidden" name="mstat" value="">
            <input type="button" value="정지"  class="new_addbtn1" title="정지" onclick="stat_change(this.value,'${list_member.mname}')">
            <input type="button" value="해제"  class="new_addbtn2" title="해제" onclick="stat_change(this.value,'${list_member.mname}')">
        </li>
    </ol>
    </cr:forEach>
</section>
...
<textarea name="terms" placeholder="이용약관에 대한 내용을 입력하세요" style="width: 100%; height: 100px; resize: none;"></textarea>
    <input type="button" onclick="update_terms('${terms_list}')"  value="이용약관 수정" title="이용약관 수정" class="btn_button" style="position: relative; left: 100%; margin-left: -100px;">
    </section>
...
<section style="width: 1100px; height: auto; margin: 0 auto; margin-top: 30px;">
    ...
    <input type="button" onclick="update_terms('${terms_list}')" value="개인정보 약관 수정" title="개인정보 약관 수정" class="btn_button" style="position: relative; left: 100%; margin-left: -100px;">
</section>
</main>
</form>
