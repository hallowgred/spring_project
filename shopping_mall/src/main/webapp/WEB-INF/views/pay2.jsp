...
상품명 : ${stringList[1]}<br>
상품가격 :	<fn:formatNumber value="${stringList[2]}" pattern="#,###"/>원<br>
상품 개수 : ${stringList[3]}EA<br>
...
주소 : <input type="text" name="rec_post" maxlength="5"><br>
<input type="text" name="rec_way" placeholder="도로명주소"><br>
<input type="text" name="rec_addr" placeholder="상세주소"><br>
<p>결제방식</p>
