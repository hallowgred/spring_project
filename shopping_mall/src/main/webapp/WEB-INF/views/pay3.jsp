...
<!-- 결제성공 및 결제실패에 대한 결과값 return으로 받는 페이지 -->
...
상품 개수 : <%=request.getAttribute("goodea") %><br>
<p>-----------------결제자 정보-----------------</p>
결제자명 : <%=request.getAttribute("buyername") %><br>
결제자연락처 : <%=request.getAttribute("buyertel") %><br>
결제자이메일 : <%=request.getAttribute("buyeremail") %><br>
<p>-----------------배송정보-----------------</p>
